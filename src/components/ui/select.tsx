...
function SelectItem({ className, children, ...props }: React.ComponentProps<typeof SelectPrimitive.Item>) {
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        'relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 text-sm outline-hidden text-foreground hover:bg-accent focus:bg-accent dark:hover:bg-muted/50 dark:focus:bg-muted/50 data-disabled:pointer-events-none data-disabled:opacity-50',
